    <xsl:template match="*[@interfaceFunctionName = 'scifunc_block_m']">
      <xsl:element name="mxCell">
        ...
        <Object>
          <xsl:attribute name="display_parameter">
            <xsl:value-of select="Array[@as='exprs']/ScilabString/data[11]/@value"/>
          </xsl:attribute>
          <xsl:attribute name="as">displayProperties</xsl:attribute>
        </Object>
        <Object>
            <xsl:for-each select="Array[@as='exprs']/ScilabString/data">
