    <xsl:template match="BasicBlock[@interfaceFunctionName = 'IdealTransformer']">
      <xsl:element name="mxCell">
        ...
        <xsl:attribute name="implicitInputPorts">2</xsl:attribute>
        <xsl:attribute name="explicitOutputPorts">0</xsl:attribute>
        <xsl:attribute name="implicitOutputPorts">2</xsl:attribute>
