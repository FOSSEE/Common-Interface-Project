...
def ConstantVoltage(outroot, attribid, ordering, geometry, parameters, parent=1, style=None, superblock=None):
    ...
    addScilabDoubleNode(innerArrayNode, width=1, realParts=[format_real_number(parameters[0])])
