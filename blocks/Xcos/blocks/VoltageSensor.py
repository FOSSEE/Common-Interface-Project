...
def VoltageSensor(outroot, attribid, ordering, geometry, parameters, parent=1, style=None, superblock=None):
    ...
    equationsArrayNode = addObjNode(outnode, TYPE_ARRAY, CLASS_TLIST, AS_EQUATIONS)
