...
def DOLLAR_m(outroot, attribid, ordering, geometry, parameters, parent=1, style=None, superblock=None):
    func_name = 'DOLLAR_m'
    if style is None:
        style = func_name
    ...
    innernode = addObjNode(outnode, TYPE_ARRAY, CLASS_LIST, AS_ODSTATE)
