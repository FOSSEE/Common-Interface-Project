...
#                 superblock_data["blocks"].append(subcell.attrib)
            ...
            for i, cell in enumerate(cells):
                try:
                    ...
                    if cell_type == 'Component':
                        ...
                        globals()[stylename](outroot, attribid, componentOrdering, componentGeometry, parameters, parent=parentattribid, style=style, superblock=superblock)
