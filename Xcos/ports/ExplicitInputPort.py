def ExplicitInputPort(outroot, attribid, parentattribid, ordering, geometry, addDataLines=False, value='', forSplitBlock=False):
...
def addExplicitInputPortForSplit(outroot, splitBlock, sourceVertex, targetVertex, sourceType, targetType, edgeDict, inputCount, outputCount, nextAttrib, nextAttribForSplit):
    inputCount += 1
    geometry = {}
    geometry['width'] = 8
    geometry['height'] = 8
    ...
    edgeDict[nextAttribForSplit] = ('ExplicitLink', sourceVertex, nextAttrib, sourceType, 'ExplicitInputPort')
    nextAttrib += 1
