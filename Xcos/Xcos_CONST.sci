...
function [explicit_output_vector, implicit_output_vector, command_vector, new_state_vector] = Xcos_CONST(time, explicit_input_vector, implicit_input_vector, control_vector, block_parameters, state_vector)
